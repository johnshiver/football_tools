...
LEAGUE_SETTINGS = {
    "Chris": LeagueConfig(11, ['Tevin Coleman']),
    "John": LeagueConfig(2, ['DeMarco Murray']),
    "Andy": LeagueConfig(12, ['Melvin Gordon', 'Tom Brady']),
    "Tara": LeagueConfig(7, ['Michael Crabtree', 'Doug Baldwin']),
    "Dan": LeagueConfig(5, []),
    "Jason": LeagueConfig(9, ['Devonta Freeman', 'LeSean McCoy']),
    "Finck": LeagueConfig(10, ['David Johnson', 'Tyler Eifert']),
    "Jim": LeagueConfig(1, ['Jordan Howard', 'Derrick Henry']),
    "Harry": LeagueConfig(4, ['Derek Carr', 'Rob Kelley']),
    "Brad": LeagueConfig(6, ['Matt Ryan', 'Isaiah Crowell']),
    "Anthony": LeagueConfig(8, ['Mike Evans', "Le'Veon Bell"]),
    "Megan": LeagueConfig(3, ['Jay Ajayi', 'Michael Thomas']),
}
